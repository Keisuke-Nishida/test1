...
class CreateInvoiceDataTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoice_data', function (Blueprint $table) {
            ...
            $table->string('sale_no', 7)->nullable()->comment('売上ＮＯ');
            ...
            $table->string('pieces', 2)->nullable()->comment('個口数');
            $table->string('account', 1)->nullable()->comment('口座');
            $table->string('division', 20)->nullable()->comment('部課');
