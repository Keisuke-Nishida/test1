        ...
        "columns": [
            ...
            { "data": "name" },
            {
                ...
                "render": function(data, type, row) {
                    return get_list_link("edit", 0, "/admin/message/edit/" + row["id"], "list-button", row["id"], 'edit');
                }
            },
            { "data": "key" },
            { "data": "value" },
            {
                ...
                "orderable": false,
                "render": function(data, type, row) {
                    return get_list_link("remove", row["id"], "/admin/message/delete_single", "list-button");
                }
            }
        ],
    });
...
$(document).ready(function() {
    ...
    $("#message-detailed-search-submit").click(function() {
        $("#message-table").DataTable().destroy();
        search_main_list();
    });

    $("#message-detailed-search-reset").click(function() {
        clear_search_fields();
        $("#message-table").DataTable().destroy();
        search_main_list();
    });

    $("#message-select-all").click(function() {
        if ($("#message-select-all").is(":checked")) {
    ...
    $("#message-multiple-delete-button").click(function(e) {
        $("#confirm_url").val($(this).data("url"));
    ...
    $("#message-form-cancel").click(function(e) {
        $("#confirm_url").val($(this).data("url"));
        $("#confirm_modal").modal("show");
    });
});
