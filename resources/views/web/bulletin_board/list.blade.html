...
<head>
    ...
    <title>掲示板一覧 | タキイ Web情報閲覧サービス</title>
</head>
            ...
            <div class="col py-3">
                <div class="content bg-white shadow content__card--round p-4">
                    <ul class="article-list list-unstyled">
                        <a class="text-decoration-none" href="./detail.blade.html">
                            <li class="article-list__item media p-4">
                                <div class="media-body row">
                                    ...
                                    <div class="col-10">
                                        ...
                                        <small class="article-list__date">2020.10.01</small>
                                        <p class="article-list__text mb-0 mb-0 text-secondary"
                                            style="font-size: 0.9em;">
                                            ・特別付録　家庭菜園の基礎知識　野菜作りをはじめよう。・50号記念特別企画インタビュー...
                                        </p>
                                    </div>
                                </div>
                            </li>
                        ...
                        <a class="text-decoration-none" href="./detail.blade.html">
                            <li class="article-list__item media p-4 mt-3">
                                <div class="media-body row">
                                    <div class="col-2">
                                        <img src="../../../public/images/bbs_image2.png" width="100%">
                                    </div>
                                    <div class="col-10">
                                        <h3 class="article-list__title m-0"><u>2020年春 種特集号 vol.49</u></h3>
                                        <small class="article-list__date">2020.04.01</small>
                                        <p class="article-list__text mb-0 mb-0 text-secondary"
                                            style="font-size: 0.9em;">
                                            ・特別付録　もぎたてフルーツを楽しむ　家庭で育てる果樹講座 後編。・タキイ春の品種カタログ...
                                        </p>
                                    </div>
                                </div>
                            </li>
                        ...
                        <a class="text-decoration-none" href="./detail.blade.html">
                            <li class="article-list__item media p-4 mt-3">
                                <div class="media-body row">
                                    <div class="col-2">
                                        <img src="../../../public/images/bbs_image3.png" width="100%">
                                    </div>
                                    <div class="col-10">
                                        <h3 class="article-list__title m-0"><u>2019年秋 種特集号 vol.48</u></h3>
                                        <small class="article-list__date">2019.10.01</small>
                                        <p class="article-list__text mb-0 mb-0 text-secondary"
                                            style="font-size: 0.9em;">
                                            ・特別付録　もぎたてフルーツを楽しむ　家庭で育てる果樹講座 全編。・タキイ秋の品種カタログ...
                                        </p>
                                    </div>
                                </div>
                            </li>
        ...
        <div class="contariner">
            <div class="row m-0">
                <div class="col text-center p-2">
                    <small class="footer__text text-white">○○ inc. All Rights Reserved.</small>
                </div>
            </div>
        </div>
    </footer>
