...
<head>
    ...
    <title>出荷詳細 | タキイ Web情報閲覧サービス</title>
</head>
...
<body class="page">
    ...
    <div class="container  mb-5">
            ...
            <div class="flex-grow-1 page__breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a class="link__main" href="../shipment/index.blade.html">出荷管理</a>
                        </li>
        ...
        <div class="row">
            <div class="col py-3">
                            ...
                            <table id="main_list" class="main-list__table table table-bordered table-sm bg-white mb-0">
                                <thead class="main-list__thead th-sm">
                                    <tr>
                                        ...
                                        <th class="instruction_number">指図番号</th>
                                        <th class="delivery_date">（希望）納期</th>
                                        <th class="delivery_date_category_name">（希望）納期区分名</th>
                                    </tr>
                                </thead>
                                <tbody class="main-list__tbody">
                                    <tr>
                                        ...
                                        <td class="delivery_date">2020/01/01</td>
                                        <td class="delivery_date_category_name">○○○○○○○○○○</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="row mt-2">
                    <div id="" class="col ">
                        <!-- 表 -->
                        <div class="table-responsive main-list__detail__table">
                            <table id="main_list" class="main-list__table table table-bordered table-sm bg-white">
                                <!-- 表頭 -->
                                <thead class="main-list__thead main-list__detail__thead th-sm">
                                    <tr class="fixed-header-0">
                                        ...
                                        <th class="situation">状況</th>
                                        <th class="product_lot">製品ロット</th>
                                        <th class="transportation_method">運送方法区分</th>
                                        <th class="transportation_service_name">扱便名区分</th>
                                        <th class="invoice_number">送り状No.</th>
        ...
        <div class="d-flex justify-content-center mt-2">
            <div class="text-nowrap">
                <a href="./index.blade.html" class="button__main--outline btn btn-sm px-3">出荷管理へ戻る</a>
            </div>
        </div>
    ...
    <script src="../../../public/js/data_shipment.js"></script>
    <script src="../../../public/js/shipment.js"></script>
    <!-- ヘッダー固定テーブル -->
